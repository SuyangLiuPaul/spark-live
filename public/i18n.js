...
const DICT = {
  en: {
    ...
    srcAuto: "Auto-detect (can't tell Cantonese from Mandarin)",
    srcLangHint: "Pick the variety the speaker uses. Auto-detect writes Cantonese as Mandarin.",
  ...
  prs: {
    ...
    srcAuto: "تشخیص خودکار (کانتونی را از ماندارین تشخیص نمی‌دهد)",
    srcLangHint: "گویشی را که سخنران استفاده می‌کند انتخاب کنید.",
  ...
  zh: {
    ...
    srcLangLabel: "來源語言",
    srcAuto: "自動偵測（無法分辨廣東話與普通話）",
    srcLangHint: "請選擇講者實際使用的語言。自動偵測會把廣東話寫成普通話。",
    asrLabel: "語音辨識",
