...
const DICT = {
  en: {
    ...
    quotaOk: (h, n) => `Quota: about ${h} hours of speech left today (${n} keys).`,
  ...
  prs: {
    ...
    quotaOk: (h, n) => `سهمیه: حدود ${h} ساعت گفتار برای امروز باقی مانده (${n} کلید).`,
  ...
  zh: {
    ...
    checkCode: "請確認代碼",
    missingCode: "缺少場次代碼",
    quotaOk: (h, n) => `額度：今天還可以講約 ${h} 小時（${n} 把金鑰）。`,
