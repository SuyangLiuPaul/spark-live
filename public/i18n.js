...
const DICT = {
  en: {
    endNotDelivered: "Couldn't tell the audience the session ended — they may still see it as live.",
    quotaBack: "Quota recovered — transcription resumed.",
    stateInterrupted: "Interrupted",
    resumeFound: "Session recovered — press Resume to start listening again.",
    resumeTitle: "Session interrupted",
    resumeBody: "The audience is still connected and can see the transcript so far. Press Resume to start listening again.",
    resume: "▶ Resume",
    stateIdle: "Not started", stateLive: "Live", stateEnded: "Ended",
    tagline: "Any language → your audience",
    ...
    srcAuto: "Auto-detect",
    srcLangHint: "Auto is fine with Gemini — measured on real Cantonese it kept the Cantonese instead of rewriting it as Mandarin. Naming the language does no harm.",
    srcLangHintWhisper: "Pick the variety the speaker uses. With Whisper, auto-detect writes Cantonese as Mandarin.",
    asrLabel: "Speech recognition",
    asrHintRelay: "Gemini streaming, ready to use — the key lives on the relay, so nothing to set up on this device.",
    asrHintReady: "Gemini keeps Cantonese verbatim instead of rewriting it as Mandarin, and biases toward your glossary before it mishears a term.",
    asrHintNeedKey: "Gemini streaming needs a Gemini key below — it connects from this browser. Without one, Whisper is used.",
    ...
    noRecording: "No recording was captured for this session.",
    recordingTruncated: "This browser can't record efficiently, so only the last 45 minutes were kept.",
    recordingStopped: "The microphone was replaced mid-session, so the recording ends at that point. The transcript is complete.",
    micStalled: "Microphone stopped sending audio — check the cable or Bluetooth connection.",
    micBack: "Microphone is sending audio again.",
    downloadText: "Download transcript",
    noTranscript: "There is nothing transcribed yet.",
    markOffline: "internet lost \u2014 the audience stopped receiving from here",
    markOnline: "internet back",
    markAsrDown: "speech recognition dropped \u2014 words may be missing from here",
    markAsrUp: "speech recognition reconnected",
    markResumed: "session interrupted, then resumed",
    micChanged: "The original microphone did not come back, so a different input is being used. Check it is the right one.",
  ...
  prs: {
    endNotDelivered: "پایان جلسه به حاضران اعلام نشد — ممکن است هنوز آن را زنده ببینند.",
    quotaBack: "سهمیه بازگشت — رونویسی از سر گرفته شد.",
    stateInterrupted: "قطع شد",
    resumeFound: "جلسه بازیابی شد — برای شنیدن دوباره Resume را بزنید.",
    resumeTitle: "جلسه قطع شد",
    resumeBody: "حاضران هنوز متصل‌اند و متن تا اینجا را می‌بینند. برای ادامهٔ شنیدن Resume را بزنید.",
    resume: "▶ ادامه",
    stateIdle: "شروع نشده", stateLive: "زنده", stateEnded: "پایان یافت",
    tagline: "هر زبانی ← برای حاضران شما",
    ...
    srcAuto: "تشخیص خودکار",
    srcLangHint: "با جیمینای حالت خودکار مشکلی ندارد — در آزمایش، کانتونی همان‌طور که بود نوشته شد.",
    srcLangHintWhisper: "زبان گوینده را انتخاب کنید. با ویسپر، تشخیص خودکار کانتونی را ماندارین می‌نویسد.",
    asrLabel: "تشخیص گفتار",
    asrHintRelay: "جیمینای آمادهٔ استفاده است — کلید در رله نگهداری می‌شود و روی این دستگاه چیزی لازم نیست.",
    asrHintReady: "جیمینای کانتونی را عیناً می‌نویسد و اصطلاحات فهرست شما را پیش از اشتباه شنیدن در نظر می‌گیرد.",
    asrHintNeedKey: "جیمینای به کلید جیمینای در پایین ضرورت دارد و از همین مرورگر وصل می‌شود. بدون آن ویسپر کار می‌کند.",
    ...
    noRecording: "برای این جلسه ضبطی انجام نشد.",
    recordingTruncated: "این مرورگر نمی‌تواند به‌خوبی ضبط کند، بنابراین فقط ۴۵ دقیقهٔ آخر نگه داشته شد.",
    recordingStopped: "مایکروفون در میان جلسه تعویض شد، بنابراین ضبط تا همان‌جا است. متن کامل است.",
    micStalled: "مایکروفون صدا نمی‌فرستد — کیبل یا اتصال بلوتوث را بررسی کنید.",
    micBack: "مایکروفون دوباره صدا می‌فرستد.",
    downloadText: "دانلود متن",
    noTranscript: "هنوز چیزی رونویسی نشده است.",
    markOffline: "اینترنت قطع شد \u2014 از اینجا حاضرین دیگر چیزی دریافت نکردند",
    markOnline: "اینترنت وصل شد",
    markAsrDown: "تشخیص گفتار قطع شد \u2014 ممکن است از اینجا کلماتی کم باشد",
    markAsrUp: "تشخیص گفتار دوباره وصل شد",
    markResumed: "جلسه قطع شد و دوباره ادامه یافت",
    micChanged: "مایکروفون اصلی برنگشت، بنابراین از ورودی دیگری استفاده می‌شود. بررسی کنید درست باشد.",
  ...
  zh: {
    endNotDelivered: "未能通知聽眾工作階段已結束 — 他們可能仍看到進行中。",
    quotaBack: "配額已恢復 — 逐字稿繼續。",
    stateInterrupted: "已中斷",
    resumeFound: "已恢復這場工作階段 — 按「繼續」重新開始收音。",
    resumeTitle: "工作階段中斷",
    resumeBody: "聽眾仍然連線中，能看到目前為止的逐字稿。按「繼續」重新開始收音。",
    resume: "▶ 繼續",
    ...
    srcLangLabel: "來源語言",
    srcAuto: "自動偵測",
    srcLangHint: "用 Gemini 時留在自動就可以 —— 實測廣東話會原樣保留，不會被寫成普通話。指定語言也沒有壞處。",
    srcLangHintWhisper: "請選擇講者實際使用的語言。用 Whisper 時，自動偵測會把廣東話寫成普通話。",
    asrLabel: "語音辨識",
    asrHintRelay: "Gemini 串流，開箱即用 —— 金鑰在中繼伺服器上，這台裝置不用設定任何東西。",
    asrHintReady: "Gemini 會逐字保留廣東話，不會改寫成普通話；也會在聽錯之前先偏向你的術語表。",
    asrHintNeedKey: "Gemini 串流需要下方的 Gemini 金鑰（由這個瀏覽器直接連線）。沒有就用 Whisper。",
    ...
    noRecording: "這場沒有錄到任何錄音。",
    recordingTruncated: "此瀏覽器無法有效錄音，因此只保留了最後 45 分鐘。",
    recordingStopped: "中途更換了麥克風，錄音只到那個時間點為止，但逐字稿是完整的。",
    micStalled: "麥克風沒有送出聲音 — 請檢查線材或藍牙連線。",
    micBack: "麥克風已恢復送出聲音。",
    downloadText: "下載逐字稿",
    noTranscript: "目前還沒有任何逐字稿。",
    markOffline: "網路中斷 \u2014 從這裡開始會眾收不到內容",
    markOnline: "網路已恢復",
    markAsrDown: "語音辨識中斷 \u2014 從這裡開始可能有漏字",
    markAsrUp: "語音辨識已恢復",
    markResumed: "工作階段中斷後已續接",
    micChanged: "原來的麥克風沒有回來，目前改用另一個輸入。請確認是不是正確的那一支。",
